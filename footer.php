  ...
  <div class="container">
    <div class="row footer-navigation">
      <div class="col-sm-3 hidden-xs" id="usa-map">
        <img src="<?php echo get_template_directory_uri(); ?>/img/inline-map.svg.php?primary=<?php echo esc_attr($idaho_webmaster_color_primary); ?>&amp;secondary=<?php echo esc_attr($idaho_webmaster_color_secondary); ?>"
          alt="Map of the USA" class="img-responsive">
      </div>
    ...
    <div class="row">
      <div class="footer-links mx-auto align-middle" aira-label="State of Idaho required links">
        <a href="https://idaho.gov" target="_blank" rel="noopener noreferrer">Idaho.gov</a> | <a href="https://idaho.gov/about-us/accessibility/"
          target="_blank" rel="noopener noreferrer">Accessibility</a> | <a href="https://cybersecurity.idaho.gov/"
          target="_blank">Cybersecurity</a> | <a href="https://idaho.gov/about-us/privacy-policy/" target="_blank" rel="noopener noreferrer">Privacy</a>
...
<?php
if (get_theme_mod('idaho_google_analytics') != "") { ?>
<script>
  ...
  ga('create', '<?php echo get_theme_mod("idaho_google_analytics"); ?>', 'auto');
  ga('send', 'pageview');
</script>
<?php } wp_footer(); ?>
</body>
